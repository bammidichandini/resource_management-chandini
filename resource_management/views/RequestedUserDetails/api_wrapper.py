...
from resource_management.constants.exception_messages import INVALID_ID
from .validator_class import ValidatorClass
from django_swagger_utils.drf_server.exceptions import BadRequest
from resource_management.interactors.get_user_requests_interactor \
    import GetUserRequestsInteractor
...
def api_wrapper(*args, **kwargs):
    ...
    try:
        requests_dict_list = interactor.get_user_requests_interactor(
            user_id=user.id,
            offset=offset,
            limit=limit
            )
        data = json.dumps({'Requests': requests_dict_list})
