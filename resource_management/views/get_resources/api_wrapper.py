...
from resource_management.interactors.get_resource_interactor \
    import GetResourcesInteractor
...
def api_wrapper(*args, **kwargs):
    ...
    try:
        resources_dict_list = interactor.get_resources_interactor()
        data = json.dumps({'Resources': resources_dict_list})
