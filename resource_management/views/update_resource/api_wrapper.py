...
from resource_management.interactors.update_resource_interactor \
    import UpdateResourceInteractor
...
def api_wrapper(*args, **kwargs):
    ...
    try:
        ...
        success_repsonse = "Successfully updated the previous resource"
